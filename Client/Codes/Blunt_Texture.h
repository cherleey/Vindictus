#ifndef Blunt_Texture_h__
#define Blunt_Texture_h__
...
class CBlunt_Texture : public Engine::CGameObject
{
private:
	explicit CBlunt_Texture(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CBlunt_Texture(void);
public:
...
public:
	static CBlunt_Texture* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vAngle);
	virtual void Free(void);
};


#endif // Blunt_Texture_h__
