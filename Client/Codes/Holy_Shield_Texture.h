#ifndef Holy_Shield_Texture_h__
#define Holy_Shield_Texture_h__
...
class CHoly_Shield_Texture : public Engine::CGameObject
{
private:
	explicit CHoly_Shield_Texture(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CHoly_Shield_Texture(void);
public:
...
public:
	static CHoly_Shield_Texture* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vAngle);
	virtual void Free(void);
};


#endif // Holy_Shield_Texture_h__
