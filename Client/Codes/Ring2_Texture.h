#ifndef Ring2_Texture_h__
#define Ring2_Texture_h__
...
class CRing2_Texture : public Engine::CGameObject
{
private:
	explicit CRing2_Texture(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CRing2_Texture(void);
public:
...
public:
	static CRing2_Texture* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vAngle);
	virtual void Free(void);
};


#endif // Ring2_Texture_h__
