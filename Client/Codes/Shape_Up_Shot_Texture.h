#ifndef Shape_Up_Shot_Texture_h__
#define Shape_Up_Shot_Texture_h__
...
class CShape_Up_Shot_Texture : public Engine::CGameObject
{
private:
	explicit CShape_Up_Shot_Texture(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CShape_Up_Shot_Texture(void);
public:
...
public:
	static CShape_Up_Shot_Texture* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vAngle);
	virtual void Free(void);
};


#endif // Shape_Up_Shot_Texture_h__
