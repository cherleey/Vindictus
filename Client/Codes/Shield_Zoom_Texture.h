#ifndef Shield_Zoom_Texture_h__
#define Shield_Zoom_Texture_h__
...
class CShield_Zoom_Texture : public Engine::CGameObject
{
private:
	explicit CShield_Zoom_Texture(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CShield_Zoom_Texture(void);
public:
...
public:
	static CShield_Zoom_Texture* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vAngle);
	virtual void Free(void);
};


#endif // Shield_Zoom_Texture_h__
