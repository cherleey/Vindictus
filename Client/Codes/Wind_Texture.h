#ifndef Wind_Texture_h__
#define Wind_Texture_h__
...
class CWind_Texture : public Engine::CGameObject
{
private:
	explicit CWind_Texture(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CWind_Texture(void);
public:
...
public:
	static CWind_Texture* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vAngle);
	virtual void Free(void);
};


#endif // Wind_Texture_h__
