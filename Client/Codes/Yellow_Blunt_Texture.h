#ifndef Yellow_Blunt_Texture_h__
#define Yellow_Blunt_Texture_h__
...
class CYellow_Blunt_Texture : public Engine::CGameObject
{
private:
	explicit CYellow_Blunt_Texture(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CYellow_Blunt_Texture(void);
public:
...
public:
	static CYellow_Blunt_Texture* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vAngle);
	virtual void Free(void);
};


#endif // Yellow_Blunt_Texture_h__
